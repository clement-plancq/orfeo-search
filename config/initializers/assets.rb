...
Rails.application.config.assets.precompile += %w( bootstrap-table.js bootstrap-table.css bootstrap-table-en-US.js bootstrap-table-fr-FR.js bootstrap-table-export.js tableExport.js)
